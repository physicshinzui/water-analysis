...
# water_index_path='/Users/siida/Dropbox/00_Research/06_coronavirus/analysis/wat_resident_time/entire_protein/1uk3'
# traj_path='/Volumes/siida-SSD/cryptic_project/corona_1uk3/xtc_files/system/skip100/' 
# ref_path='/Users/siida/Dropbox/00_Research/06_coronavirus/analysis/wat_resident_time/1uk3/em2.pdb'

# water_index_path='/Users/siida/Dropbox/00_Research/06_coronavirus/analysis/wat_resident_time/entire_protein/1uk3_A'
# traj_path='/Volumes/siida-SSD/corona_project/corona_A_1uk3/xtc_files/system/skip100/' 
# ref_path='/Users/siida/Dropbox/00_Research/06_coronavirus/analysis/wat_resident_time/1uk3_A/em2.pdb'
...
for i in $(seq 2 2); do
    ${exe} -c spotting_water.py -- ${water_index_path}/tau_${i}.out \
                                   ${ref_path} \
                                   ${traj_path}/npt_prod_${i}_skip100.xtc
    trajno=$(($i+1))
    mv fig.png fig_${trajno}.png
    mv session.pse ${trajno}.pse
done
